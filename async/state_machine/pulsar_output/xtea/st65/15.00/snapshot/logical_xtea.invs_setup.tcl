...
source output/xtea/st65/15.00/snapshot/logical_xtea.flowkit_settings.tcl

source output/xtea/st65/15.00/snapshot/logical_xtea.invs_init.tcl
...
source output/xtea/st65/15.00/snapshot/logical_xtea.attrs.tcl

## Reading common preserve file for dont_touch and dont_use preserve settings
source output/xtea/st65/15.00/snapshot/logical_xtea.preserve.tcl



# Mode Setup
###########################################################
source output/xtea/st65/15.00/snapshot/logical_xtea.mode
...
if {[is_attribute -obj_type port original_name] && [is_attribute -obj_type pin original_name] && [is_attribute -obj_type pin is_phase_inverted]} {
  source output/xtea/st65/15.00/snapshot/logical_xtea.wnm_attrs.tcl
}
