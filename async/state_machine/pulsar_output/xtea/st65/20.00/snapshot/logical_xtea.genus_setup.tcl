...
########################################################
source output/xtea/st65/20.00/snapshot/logical_xtea.genus_init.tcl
read_metric -id current output/xtea/st65/20.00/snapshot/logical_xtea.metrics.json

source output/xtea/st65/20.00/snapshot/logical_xtea.g.gz
...
if {$_cell_area_ != "53682"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 53682,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "22628"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 22628,  current net area: $_net_area_"
}
unset _net_area_
