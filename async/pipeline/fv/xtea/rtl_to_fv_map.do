...
# Generated on: Sun Jan 12 13:23:58 -02 2020 (Sun Jan 12 15:23:58 GMT 2020)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/xtea/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/xtea -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/soft64/cadence/ferramentas/GENUS181/tools.lnx86"
set CDN_SYNTH_ROOT      "/soft64/cadence/ferramentas/GENUS181/tools.lnx86"
set env(CW_DIR) "/soft64/cadence/ferramentas/GENUS181/tools.lnx86/lib/chipware"
set CW_DIR      "/soft64/cadence/ferramentas/GENUS181/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path . tech /home/msartori/developer/phd/research/pulsar/tech -library -both
read_library -liberty -both   /home/msartori/developer/phd/research/pulsar/tech/nand2.lib
...
add_search_path . rtl /home/msartori/developer/phd/research/pulsar/tech -design -golden
read_design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab  -vhdl 93  rtl/xtea.vhd
elaborate_design -golden -root {xtea} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/xtea/fv_map.v.gz
elaborate_design -revised -root {xtea}
...
#add_name_alias fv/xtea/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both

add_module_attribute xtea -pipeline_retime -both
add_noblack_box xtea -submodules -both
